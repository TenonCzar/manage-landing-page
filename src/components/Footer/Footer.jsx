...
const Footer = () => {
  return (
    <div className="flex flex-col pt-10 grey9 items-center justify-center md:justify-between px-12 text-white md:flex-row-reverse relative md:items-start">
      ...
      <div className="social flex flex-col-reverse gap-12 items-center md:flex-col md:items-start mb-10">
        <img src={Logo} alt="" className="logo invert brightness-0" />
        <div className="social-links flex gap-6 items-center">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 20 20"
            class="w-7 h-7 text-white hover:fill-amber-400 cursor-pointer"
          >
            <path
              fill="currentColor"
