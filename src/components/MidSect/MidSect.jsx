...
const MidSect = () => {
  return (
    <div className="flex flex-col items-center gap-6 justify-between my-20 md:flex-row md:items-start mx-10 md:mx-20 text-gray-400 md:gap-24">
      <div className="writeup text-center md:text-left w-[300px] md:w-[400px] gap-3 flex flex-col">
        <h2 className="text text-4xl font-bold leading-12">
      ...
      <div className="points flex flex-col gap-8 mt-6 md:mt-0 w-full bg-amber-400">
        <div className="point1 flex flex-col gap-2 font-semibold w-full">
          ...
          <p className="pr-8 text-md md:pl-21 md:pr-12 md:w-[530px] md:font-normal">
        ...
        <div className="point1 flex flex-col gap-2 font-semibold w-full">
          ...
          <p className="pr-8 text-md md:pl-21 md:w-[530px] md:font-normal">
